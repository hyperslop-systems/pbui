...
const types: Record<PresentationType, TypeSpec> = {
  ...
  tile: {
    ...
    tone: TONES.tile,
    verbs: ["placement.duplicate", "placement.close", "view.show", "view.configure", "askAgent"],
  ...
  workspace: {
    ...
    verbs: ["session.selectWorkspace", "workspace.rename", "workspace.delete", "workspace.clone", "askAgent"],
