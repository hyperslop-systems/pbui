...
import { coordinationInspectorApp, defineWorkbenchApp, type AppProps, type WorkbenchApp } from "@hyperslop-systems/pbui-workbench";
...
export function createShopApps(shop: Shop): WorkbenchApp[] {
  return [
    defineWorkbenchApp({
      manifest: {
        id: APP_IDS.orders,
