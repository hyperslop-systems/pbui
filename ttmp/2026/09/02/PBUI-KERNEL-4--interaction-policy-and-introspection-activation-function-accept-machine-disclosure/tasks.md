...
- [x] P4: refusal presentation: refusal in context, RefusalNotice chrome, onRefuse optional hook <!-- t:rfji -->
- [x] P5: explain(query, disclosure) over the original menu/primary query; public omits hidden detail <!-- t:x0hc -->
- [x] P6: §19.8 DOM tests, screenshots, README, changelog, index status <!-- t:nyz7 -->
